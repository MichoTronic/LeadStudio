# Lead Studio ProjectControl

This is the navigation index for current Lead controls. It does not own policy.

| Function | Files |
| --- | --- |
| Current architecture and work | `system-overview.md`, `checklist-project.md`, `decision-log.md` |
| Version-level future/deferred intent | `plan-release-roadmap.md` |
...
| Historical documentation inventory | `DocumentationArchive/README.md` |
...
`GOV-003` and `GOV-008` through `GOV-014`. Lead files add only Lead-specific facts,
