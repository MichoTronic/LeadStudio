...
| `ProjectControl/system-overview.md` | Stable architecture and ownership |
| `ProjectControl/checklist-project.md` | Active/deferred/completed work once only |
| `ProjectControl/decision-log.md` | Durable decisions and supersessions |
| `ProjectControl/governance-release.md` | Environment, promotion, and rollback rules |
...
- Keep the active task once in `checklist-project.md`.
